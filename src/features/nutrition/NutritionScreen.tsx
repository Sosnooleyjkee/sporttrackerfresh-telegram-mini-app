...
const styles = StyleSheet.create({
  ...
  heroBadge: { paddingHorizontal: 12, paddingVertical: 10, borderRadius: 18, borderWidth: 1, borderColor: "rgba(245,158,11,0.24)", backgroundColor: "rgba(245,158,11,0.08)", gap: 2 },
  heroBadgeLabel: { color: appTheme.colors.textMuted, fontSize: 10, fontWeight: "700", textTransform: "uppercase", letterSpacing: 0.5 },
  heroBadgeValue: { color: appTheme.colors.textPrimary, fontSize: 13, fontWeight: "800" },
